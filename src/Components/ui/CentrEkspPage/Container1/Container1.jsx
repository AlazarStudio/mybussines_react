      ...
      <div className={classes.container}>
        ...
        <div className={classes.containerRight}>
          ...
          <span>
            ...
            структурным подразделением в составе Центра «Мой бизнес» КЧР и относится к инфраструктуре поддержки малого и
            среднего предпринимательства, которая способствует созданию
