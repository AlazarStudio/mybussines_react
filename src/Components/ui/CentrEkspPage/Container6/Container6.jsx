        ...
        <WidthBlock>
          <div className={classes.container}>
            <div className={classes.containerLeft}>
              ...
              <span>
                В настоящее время в своей работе Центр поддержки экспорта КЧР руководствуется Приказом Министерства экономического развития РФ №77 от 18 февраля 2021г. Центр координации поддержки экспортно ориентированных субъектов
            ...
            <div className={classes.containerRight}>
              ...
              <span><img src='/images/centrEksp6.png'/>+7(8782) 25-02-27 (доб. 810)
              </span>
