          ...
          <div className={classes.container}>
            <div className={classes.containerLeft}>
              ...
              <span>
                ...
                развития Российской Федерации от 14 марта 2019 г. № 195 «Об
                ...
                субъектов малого и среднего предпринимательства». Кроме того, в
                своей деятельности руководствуется Приказом Минэкономразвития
                России от 29.11.2019 №773 (ред. от 22.02.2024) — «Об утверждении
                Порядка признания субъекта малого или среднего
                предпринимательства социальным предприятием и Порядка
                формирования перечня субъектов малого и среднего
                предпринимательства, имеющих статус социального предприятия»».
              </span>
            </div>
