            ...
            <div className={classes.containerBlock}>
              <div className={classes.containerBlockEl}>
                ...
                <span className={classes.tr}>
                  ...
                  <span>
                    В 2024 году среднесписочная численность работников,
                ...
                <span className={classes.tr}>
                  <img src="/images/tr.png" />
                  <span>
                    В 2024 году доля расходов на оплату труда таких лиц
              ...
              <div className={classes.containerBlockEl}>
                ...
                <span className={classes.tr}>
                  <img src="/images/tr.png" />
                  <span>
                    Выручка за 2024 год от указанной деятельности составляет не
              ...
              <div className={classes.containerBlockEl3}>
                <span>
                  Категория 3. Производство товаров/услуг (предназначенных для
                ...
                <span className={classes.tr}>
                  <img src="/images/tr.png" />
                  <span>
                    Целевая аудитория вашего бизнеса — лица из незащищенных
                    категорий
                  </span>{' '}
                </span>
                <span className={classes.tr}>
                  <img src="/images/tr.png" />
                  <span>
                    Вы оказываете им определенные виды услуг или продаете
                ...
                <span className={classes.tr}>
                  <img src="/images/tr.png" />
                  <span>
                    В 2024 году данная деятельность принесла не менее 50 % вашей
                    выручки
                  </span>{' '}
                </span>
                <span>Перечень документов для 3 категории:</span>
                <a href="/prilozhenie-1.rtf" download="prilozhenie-1.rtf">
                  Заявление Приложение 1
                </a>
                <a href="/prilozhenie-2.rtf" download="prilozhenie-2.rtf">
                ...
                <a href="/prilozhenie-7.docx" download="prilozhenie-7.docx">
                  Сведения об осуществлении деятельности по производству товаров
                  (работ, услуг), предназначенных для граждан из числа
                  категорий, указанных в пункте 1 части 1 статьи 24.1 ФЗ от
                  24.07.2007г. №209-ФЗ «О развитии малого и среднего
                  предпринимательства в РФ» Приложение 7
                </a>
              </div>
              <div className={classes.containerBlockEl3}>
                <span>
                  Категория 4. Деятельность, направленная на общественно
                  полезные цели
                </span>
                <span></span>
                <span>Условия:</span>
                <span className={classes.tr}>
                  <img src="/images/tr.png" />
                  <span>
                    Вы осуществляете один из социальных видов деятельности
                  </span>{' '}
                </span>
                <span className={classes.tr}>
                  <img src="/images/tr.png" />
                  <span>
                    Эта деятельность в 2024 году принесла вам не менее 50% от
                    общей выручки по всем вашим видам деятельности
                  </span>{' '}
                </span>
                <span className={classes.tr}>
                  <img src="/images/tr.png" />
                  <span>
                    Кто у вас работает и кто является покупателями, совершенно
                    не важно!
                  </span>{' '}
                </span>
                <span>Перечень документов для 4 категории:</span>
                <a href="/prilozhenie-1.rtf" download="prilozhenie-1.rtf">
                  Заявление Приложение 1
                </a>
                <a href="/prilozhenie-2.rtf" download="prilozhenie-2.rtf">
                ...
                <a href="/prilozhenie-8.docx" download="prilozhenie-8.docx">
                  Сведения об осуществлении деятельности, направленной на
                  осуществление общественно полезных целей и способствующей
                  решению социальных проблем общества в соответствии с пунктом 4
                  части 1 статьи 24.1 ФЗ от 24.07.2007г. №209-ФЗ «О развитии
                  малого и среднего предпринимательства в РФ» Приложение 8
                </a>
              </div>
            </div>
          </div>
