...
import { TagsSupportCreate, TagsSupportEdit, TagsSupportList } from './ProductsComponent/TagsSupportComponent';
...
const AdminPage = () => (
  ...
  >
    ...
    <Resource
      options={{ label: "Теги поддержки" }} // Указываем название на русском
      name="tagsSupports"
