...
function ContactPage({ children, ...props }) {
  return (
    <>
      ...
      <div style="position:relative;overflow:hidden;"><a href="https://yandex.ru/maps/1104/cherkessk/?utm_medium=mapframe&utm_source=maps" style="color:#eee;font-size:12px;position:absolute;top:0px;">Черкесск</a><a href="https://yandex.ru/maps/1104/cherkessk/house/prospekt_lenina_53/YEsYdgNmT0AEQFpufX5zcn1lbA==/?ll=42.046653%2C44.223168&utm_medium=mapframe&utm_source=maps&z=15.84" style="color:#eee;font-size:12px;position:absolute;top:14px;">Яндекс Карты — транспорт, навигация, поиск мест</a><iframe src="https://yandex.ru/map-widget/v1/?ll=42.046653%2C44.223168&mode=search&ol=geo&ouri=ymapsbm1%3A%2F%2Fgeo%3Fdata%3DCgoxNTAxOTAyNjk2En_QoNC-0YHRgdC40Y8sINCa0LDRgNCw0YfQsNC10LLQvi3Qp9C10YDQutC10YHRgdC60LDRjyDQoNC10YHQv9GD0LHQu9C40LrQsCwg0KfQtdGA0LrQtdGB0YHQuiwg0L_RgNC-0YHQv9C10LrRgiDQm9C10L3QuNC90LAsIDUzIgoNxS8oQhWG5DBC&z=15.84" width="560" height="400" frameBorder="1" allowfullscreen="true" style="position:relative;"></iframe></div>
    </>
  );
}
