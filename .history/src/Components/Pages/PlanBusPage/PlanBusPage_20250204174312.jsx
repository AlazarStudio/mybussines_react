...
import classes from './PlanBus.module.css';
...
function PlanBus({ children, ...props }) {
          ...
          <WidthBlock>
            <div className={classes.container}>
              ...
              <div className={classes.containerText}>
                <span>Меры поддержки бизнесу в сфере легкой промышленности</span>
