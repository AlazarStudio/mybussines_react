            ...
            {service.map((el) => (
              <div className={classes.containerCard} key={el.id}>
                ...
                <div className={classes.containerCardBottom}>
                  <span>{el.title}</span>
                  <span
  className="containerCardBottom"
  onMouseEnter={(e) => (e.currentTarget.querySelector("img").src = "/images/Group15 (1).svg")}
  onMouseLeave={(e) => (e.currentTarget.querySelector("img").src = "/images/Group 15.svg")}
>
  <img src="/images/Group 15.svg" alt="icon" />
</span>
                </div>
              </div>
            ))}
