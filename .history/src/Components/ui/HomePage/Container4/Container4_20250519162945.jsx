...
function Container4({ children, ...props }) {
  ...
  const handleDownloadEng = () => {
    ...
    link.view = 'katalog_proizvedeno_v_kchr_ENG.pdf';
    link.click();
  };
  return (
    <>
      ...
      <div className={classes.container2}>
        <div className={classes.containerPdf}>
          ...
          <div className={classes.buttons}>
            <button onClick={handleDownloadRu} className={classes.downloadBtn}>
              РУС
            </button>
            <button onClick={handleDownloadEng} className={classes.downloadBtn}>
              ENG
            </button>
          </div>
        </div>
