      ...
      <CenterBlock>
        <WidthBlock>
          ...
          <div className={classes.container}>
            <div className={classes.containerEl} onClick={() => navigate('/centr_podderzhki_predprinimatelstva')}>
              <img src="/images/cen1.webp" />
              <span>Центр поддержки предпринимательства</span>
            </div>
            <div className={classes.containerEl} onClick={() => navigate('/centr_podderzhki_eksporta')}>
              <img src="/images/cen2.webp" />
              <span>Центр поддержки экспорта</span>
            </div>
            <div className={classes.containerEl} onClick={() => navigate('/centr_competencyi')}>
              <img src="/images/cen3.webp" />
              <span>Центр компетенций с/х кооперации и поддержки фермеров</span>
            </div>
            <div className={classes.containerEl} onClick={() => navigate('/center_innovacionnoy_soc_sfery')}>
