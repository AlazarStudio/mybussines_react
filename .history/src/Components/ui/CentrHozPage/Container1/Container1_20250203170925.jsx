    ...
    <>
      <div className={classes.container}>
        ...
        <div className={classes.containerRight}>
          ...
          <span>
          Центр компетенций является структурным подразделением в составе Центра «Мой бизнес» Карачаево-Черкесия и относится к инфраструктуре поддержки малого и среднего предпринимательства, который оказывает на территории КЧР информационно-консультационные услуги физическим и юридическим лицам, обеспечивает содействие в создании и развитии субъектов малого и среднего предпринимательства в сфере сельского хозяйства.
          </span>
