...
import classes from './OneSupportPage.module.css';
      ...
      <WidthBlock>
        <div className={classes.container}>
          <div className={classes.containerNav}>
            ...
            <Link to="/news">Меры поддержки / </Link>
          ...
          <div className={classes.containerNews}>
            ...
            <img src={`${uploadsConfig}${currentSupports.img[0]}`} alt={currentSupports.title} />
          </div>
        </div>
      </WidthBlock>
    </CenterBlock>
