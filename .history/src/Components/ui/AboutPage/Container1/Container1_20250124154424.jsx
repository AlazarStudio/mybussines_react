        ...
        <div className={classes.container1}>
          ...
          <div className={classes.container1Right}>
            ...
            <p>
              ...
              предпринимательства – Центр «Мой бизнес КЧР». Работа Центра
              осуществляется под кураторством Министерства Экономического
              развития Карачаево-Черкесской Республики и направлена на
              всестороннее улучшение предпринимательского климата в
              Карачаево-Черкесии.
            </p>
          </div>
        </div>
