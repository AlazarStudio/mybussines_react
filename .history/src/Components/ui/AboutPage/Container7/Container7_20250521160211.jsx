      ...
      <CenterBlock>
        <WidthBlock>
          <div className={classes.container7}>
            ...
            <div className={classes.container7Sotr}>
              <div className={classes.container7Card}>
                <img src="/images/DotdaevaZjpg.png" />
                <span>Яровчук Дарья Александровна</span>
                <span>
                 Начальник центра компетенций в сфере сельскохозяйственной кооперации и поддержки фермеров
                </span>
                <span>reception@moibiz09.ru</span>
                <span>8 (8782) 25-02-27</span>
              </div>
                <div className={classes.container7Card}>
                <img src="/images/YarovchukD.png" />
                <span>Дотдаева Замира Ильясовна</span>
                <span>
                 Главный специалист центра компетенций в сфере сельскохозяйственной кооперации и поддержки фермеров
                </span>
                <span>reception@moibiz09.ru</span>
                <span>8 (8782) 25-02-27</span>
              </div>
