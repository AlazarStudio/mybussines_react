  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const newsResponse = await fetch(`${serverConfig}/services`);
        const servicesData = await newsResponse.json();
          ...
          <div className={classes.container}>
            {services.map((el) => (
              <div className={classes.containerCard} key={el.id}>
                <img src={`${uploadsConfig}${el.img}`} className={classes.containerCardImg} />
