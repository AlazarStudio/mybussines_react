      ...
      <CenterBlock>
        <WidthBlock>
          <div className={classes.container}>
            <span className={classes.containerTitle}>Услуги</span>
            <div className={classes.containerBlock}>
              ...
              <div className={classes.containerCard}>
                ...
                <div className={classes.containerCardBottom}>
                  <span>Создание изделий на 3D-принтерах</span>
              ...
              <div className={classes.containerCard}>
                ...
                <div className={classes.containerCardBottom}>
                  <span>Компьютерный анализ и обработка изображений</span>
