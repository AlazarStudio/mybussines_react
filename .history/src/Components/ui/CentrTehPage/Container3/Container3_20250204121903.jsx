          ...
          <div className={classes.container}>
            ...
            <div className={classes.containerBottom}>
              <div className={classes.containerBottomEl}>
                ...
                <span>
                  Для лиц, ведущих личное подсобное хозяйство, фермеров, в том
                  числе и самозанятых в данной отрасли
                </span>
              </div>
              <div className={classes.containerBottomEl}>
                <img src="/images/CentrHoz4.png" />
                <span>
                  Для сельскохозяйственных, потребительских и производственных
                  кооперативов
                </span>
              </div>
              <div className={classes.containerBottomEl}>
                ...
                <span>
                  Для субъектов МСП (ИП и СХК), осуществляющие свою деятельность
