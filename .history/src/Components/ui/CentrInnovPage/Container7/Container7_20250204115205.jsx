          ...
          <div className={classes.container}>
            ...
            <div className={classes.containerBlock}>
              <div className={classes.containerBlockEl}>
                ...
                <a href="/prilozhenie-3.rtf" download="prilozhenie-2.rtf">
                Рекомендуемый перечень документов, подтверждающих отнесение гражданина к категориям, указанным в пункте 1 части 1 статьи 24.1 ФЗ от 24.07.2007г. №209 ФЗ «О развитии малого и среднего предпринимательства в РФ» Приложение 3
                </a>
