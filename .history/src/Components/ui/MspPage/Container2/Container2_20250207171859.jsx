      ...
      <div className={classes.container}>
        <div className={classes.containerEl}>
          ...
          <div className={classes.containerElText}>
            ...
            <button onClick={()=> window.location.href = 'https://xn--l1agf.xn--p1ai/education/events'}>Узнать больше</button>
          </div>
        </div>
        <div className={classes.containerEl}>
        <div className={classes.containerElText}>
            ...
            <span>
            4-дневный тренинг для тех, кто хочет начать свое дело: проверка гипотез, CustDev, первый MVP
            По результатам программы вы сможете:
            </span>
            <span>
              <img src="/images/yellow.png" />
            ...
            <span>
              <img src="/images/yellow.png" />
              определить клиентские сегменты и сформировать стратегию по привлечению клиентов
            </span>
            <span>
              <img src="/images/yellow.png" />
              рассчитать продуктовые и бизнес показатели
