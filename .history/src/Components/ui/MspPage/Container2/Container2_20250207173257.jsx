    ...
    <>
      <div className={classes.container}>
        ...
        <div className={classes.containerEl}>
          ...
          <div className={classes.containerElText}>
            <span>Мама-предприниматель</span>
            <span>В программе участницы:</span>
            <span>
              <img src="/images/yellow.png" />
              упакуют прибыльную идею для бизнеса
            </span>
            <span>
              <img src="/images/yellow.png" />
              научатся оценивать и приоритизировать бизнес-гипотезы
            </span>
            <span>
              <img src="/images/yellow.png" />
              рассчитают потенциальную прибыльность и бюджет идеи
            </span>
            <span>
              <img src="/images/yellow.png" />
              получат возможность выиграть грант на развитие бизнеса
            </span>
            <span>
              <img src="/images/yellow.png" />
              подготовят презентацию бизнеса для получения гранта
            </span>
            <span>
              <img src="/images/yellow.png" />
              получат доступ к женскому предпринимательскому сообществу
            </span>
            <button
              onClick={() =>
                (window.location.href =
      ...
      <div className={classes.containerMobil}>
        <div className={classes.containerMobilEl}>
          <div className={classes.containerMobilElLogo}>
            <img src="/images/msp4.png" />
          </div>
          <div className={classes.containerMobilElText}>
            <span>Школа предпринимательства</span>
            <span>
              5-дневный тренинг для тех, кто уже открыл бизнес и хочет его
              развить: диагностика бизнеса, команды, продуктовая матрица,
