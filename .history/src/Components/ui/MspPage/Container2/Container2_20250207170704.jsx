      ...
      <div className={classes.container}>
        <div className={classes.containerEl}>
          ...
          <div className={classes.containerElText}>
            ...
            <span><img src='/images/yellow.png'/>выявить проблемы, мешающие росту компании</span>
            <span><img src='/images/yellow.png'/>исследовать целевую аудиторию</span>
            <span><img src='/images/yellow.png'/>рассчитать продуктовые и бизнес показатели</span>
            <span><img src='/images/yellow.png'/>сформулировать стратегию развития компании</span>
            <button></button>
          </div>
        </div>
        <div className={classes.containerEl}>
