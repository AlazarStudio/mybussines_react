    ...
    <>
      ...
      <div className={classes.container}>
        ...
        <div className={classes.containerElText}>
          ...
          <span>Сертифицированный тренер Корпорации МСП с 2020 года</span>
          <span>
            <img src="/images/yellow.png" />
            Эффективен в коммуникации: способен к организации диалога как с
            группой в целом, так и с отдельными ее участниками.
          </span>
          <span>
            <img src="/images/yellow.png" />
