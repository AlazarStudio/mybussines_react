...
<div className={classes.containerEl}>
  <span><img src='/images/yellow.png'/>«Генерация бизнес-идеи»</span>
  <span>Узнаете где (источники) и как (инструменты) искать бизнес-идеи, по каким критериям выбрать самую успешную и как проверить бизнес-идею на возможность реализации;</span>
</div>
<div className={classes.containerEl}>
