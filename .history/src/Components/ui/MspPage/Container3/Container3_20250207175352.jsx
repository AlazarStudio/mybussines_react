...
<Container3></Container3>.module.css';
import CenterBlock from '../../../Standart/CenterBlock/CenterBlock';

function Container3<div className="" />
<Container3></Container3>({ children, ...props }) {
  return (
    <>
      <div className={classes.container}>
        ...
        <img src="/images/msp3.png" className={classes.pink} />
      </div>
    </>
  );
}

export default Container3<div className="" />
